  ...
  <div class="login-admin" style="">
    ...
    <div class="login-form">
      <form action="<?php echo e(route('register')); ?>" method="post">
        ...
        <input type="text" name="username" placeholder="Pseudo" value="<?php echo e(old('username')); ?>">
        ...
        <?php endif; ?>
        <input type="text" name="firstname" placeholder="Prénom" value="<?php echo e(old('firstname')); ?>">
        <?php if($errors->has('firstname')): ?>
            <span style="color:red;">
                <strong><?php echo e($errors->first('firstname')); ?></strong>
            </span>
        <?php endif; ?>
        <input type="text" name="lastname" placeholder="Nom" value="<?php echo e(old('lastname')); ?>">
        <?php if($errors->has('lastname')): ?>
            <span style="color:red;">
                <strong><?php echo e($errors->first('lastname')); ?></strong>
            </span>
        <?php endif; ?>
        <input type="text" name="country" placeholder="Pays" value="<?php echo e(old('country')); ?>">
        <?php if($errors->has('country')): ?>
            <span style="color:red;">
                <strong><?php echo e($errors->first('country')); ?></strong>
            </span>
        <?php endif; ?>
        <input type="text" name="phone" placeholder="Numéro de téléphone" value="<?php echo e(old('phone')); ?>">
