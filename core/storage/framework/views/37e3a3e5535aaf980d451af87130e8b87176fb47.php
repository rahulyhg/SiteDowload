           ...
           <div class="col-md-12">
              ...
              <div class="portlet light bordered">
                 <div class="portlet-body form">
                   ...
                   <?php endif; ?>
                    <form class="form-horizontal" action="<?php echo e(route('admin.support.store')); ?>" method="post" role="form">
                          ...
                          <div class="table-scrollable">
                             <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  ...
                                  <tr id="2">
                                     <td><i class="fa fa-<?php echo e($support->fontawesome_code); ?>"></i></td>
                                     <td><?php echo e($support->title); ?></td>
                                     <td>
                                      <button type="button" class="btn btn-danger btn-sm delete_button" data-toggle="modal" data-target="#DelModal<?php echo e($support->id); ?>" data-id="2">
                                      <i class="fa fa-times"></i> DELETE
                                      </button>
                                     </td>
                                  </tr>
                                  <!-- Modal for DELETE -->
                                  <div class="modal fade" id="DelModal<?php echo e($support->id); ?>" tabindex="-1" role="dialog">
                                     <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                           ...
                                           <form style="display:inline-block;" class="" action="<?php echo e(route('admin.support.delete')); ?>" method="post">
                                             <?php echo e(csrf_field()); ?>

                                             <input type="hidden" name="supportID" value="<?php echo e($support->id); ?>">
