...
<head>
    ...
    <meta charset="utf-8" />
    <title>Admin Login | <?php echo e($data['sitename']); ?></title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta content="width=device-width, initial-scale=1" name="viewport" />
    <link href="<?php echo e(asset('assets/admin/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('assets/admin/css/components-rounded.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<div class="logo">
    <a href="#">
        <img src="<?php echo e(asset('assets/users/interfaceControl/logoIcon/logo.jpg')); ?>" alt="X" style="width:20%;" />
    </a>
</div>
...
<div class="copyright"> <?php echo e(date('Y')); ?>  ©  <?php echo e($data['sitename']); ?> </div>
