                              ...
                              <div class="panel">
                                   <div class="panel-heading side-events-item">
                                     <div class="">
                                       <div>
                                           <p style="margin:0px;">
                                             <strong><i class="fa fa-plus" aria-hidden="true"></i> Join Date</strong> <?php echo e($user->created_at); ?>
                              ...
                              <div class="panel">
                                   <div class="panel-heading side-events-item">
                                     <div class="">
                                       <div id="balanceID">
                                           <p style="margin:0px;">
                                             <strong><i class="fa fa-money" aria-hidden="true"></i> Balance</strong> <?php echo e($user->balance); ?> <?php echo e($gs->base_curr_symbol); ?>
                              ...
                              <div class="panel">
                                   <div class="panel-heading side-events-item">
                                     <div class="">
                                       <div>
                                           <p style="margin:0px;">
                                             <strong><i class="fa fa-thumbs-o-up"></i> Positive Rating</strong> <?php echo e(App\Order::where('seller_id', $user->id)->where('like', 1)->count()); ?>
                              ...
                              <div class="panel">
                                   <div class="panel-heading side-events-item">
                                     <div class="">
                                       <div>
                                           <p style="margin:0px;">
                                             <strong><i class="fa fa-thumbs-o-down"></i> Negative Rating</strong> <?php echo e(App\Order::where('seller_id', $user->id)->where('like', 0)->count()); ?>
