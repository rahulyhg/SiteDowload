   ...
   <div class="carousel-inner">
      ...
      <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="item <?php if($loop->first): ?> active <?php endif; ?>">
          <img style="width:100%;" src="<?php echo e(asset('assets/users/interfaceControl/slider_images/1528485944.jpg')); ?>" alt="bannieresansnous" style="width:100%;">
      ...
      <div class="media single-service" style="padding:0px 40px;">
        ...
        <div class="media-body">
          <div class="media-heading-price-container">
            <h2 class="media-heading"><a href="<?php echo e(route('services.show', [$service->id, $service->user->id])); ?>" style="color: #1C1C1C; font-size: 25px;" class="text-primary"><?php echo (strlen($service->service_title)>40) ? substr($service->service_title, 0, 40) . '...' : $service->service_title; ?></a></h2>
            <small style="color:#FF1043; font-size: 14px;" class="pull-right text-danger"><strong><?php echo e($service->price); ?> <?php echo e($gs->base_curr_symbol); ?></strong></small>
          </div>
          ...
          <div class="col-md-12 description-username-container">
            ...
            <small class="col-md-2 username"><strong><a style="color:#FF1043; font-size: 14px;" class="text-danger" href="<?php echo e(route('users.profile', $service->user->id)); ?>"><?php echo e($service->user->username); ?></a></strong></small>
          </div>
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <button style="background-color:#FF1043; color:#FFFFFF; font-size:14px; font-weight:900; border-radius: 28px; border:none;" class="btn btn-danger btn-sm pull-right" class="pull-right" onclick="placeOrder(<?php echo e($service->id); ?>)">
                Réserver
              </button>
            </div>
          </div>
