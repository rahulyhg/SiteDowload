                       ...
                       <table class="table table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <tr class="bold">
                               ...
                               <td>
                                  <button class="btn btn-warning" data-toggle="modal" data-target="#editModal<?php echo e($category->id); ?>">Edit</button>
                                  <button id="featureStatusBtn29" class="btn btn-danger" type="button" name="button" data-toggle="modal" data-target="#deleteModal<?php echo e($category->id); ?>">Delete</button>
                               </td>
                            </tr>
