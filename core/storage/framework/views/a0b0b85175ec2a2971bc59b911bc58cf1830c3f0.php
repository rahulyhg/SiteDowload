...
<?php $__env->startSection('content'); ?>
  <div class="shopping-container">
    <ul class="nav nav-tabs">
      <li class="active"><a data-toggle="tab" href="#completed">Completed Orders <span class="badge"><?php echo e(\App\Order::where('status', 2)->where('seller_id', Auth::user()->id)->count()); ?></span></a></li>
      <li><a data-toggle="tab" href="#corders">Current Orders <span class="badge"><?php echo e(\App\Order::where('status', 1)->where('seller_id', Auth::user()->id)->count()); ?></span></a></li>
      <li><a data-toggle="tab" href="#porders">Pending Orders <span class="badge"><?php echo e(\App\Order::where('status', 0)->where('seller_id', Auth::user()->id)->count()); ?></span></a></li>
      <li><a data-toggle="tab" href="#rejorders">Rejected Orders <span class="badge"><?php echo e(\App\Order::where('status', -1)->where('seller_id', Auth::user()->id)->count()); ?></span></a></li>
    </ul>
