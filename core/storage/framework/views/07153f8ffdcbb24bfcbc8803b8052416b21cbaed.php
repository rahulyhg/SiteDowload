...
<div class="modal container fade" id="myModal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none; margin-top: 0px;">
   <div class="modal-content">
      <div class="modal-header">
         <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
         <h4 class="modal-title" id="myModalLabel"> <b class="abir_act">Edit</b> Withdraw Method</h4>
      </div>
      <form id="editWithdrawMethodForm" method="post" onsubmit="update(event)">
...
<?php $__env->startPush('scripts'); ?>
   <script>
      function showEditModal(wmID) {
         ...
         $.get(
            '<?php echo e(route('withdrawMethod.edit')); ?>',
            {
               wmID: wmID
            },
            function(data) {
...
<?php $__env->startPush('scripts'); ?>
   <script>
      function update(e) {
         ...
         $.ajax({
            url: '<?php echo e(route('withdrawMethod.update')); ?>',
            type: 'POST',
            data: fd,
            contentType: false,
            processData: false,
