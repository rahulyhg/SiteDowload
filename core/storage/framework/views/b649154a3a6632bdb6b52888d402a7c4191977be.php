<?php $__env->startSection('content'); ?>
  ...
  <div class="col-xs-12 col-md-8 col-md-offset-2">
  	<div class="well">
  		...
  		<hr/>
  		<form role="form" id="payment-form" method="POST" action="<?php echo e(route('ipn.stripe')); ?>">
  ...
  <script type="text/javascript" src="<?php echo e(asset('assets/users/stripe/payvalid.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(asset('assets/users/stripe/paymin.js')); ?>"></script>
  <script type="text/javascript" src="https://js.stripe.com/v2/"></script>
  <script type="text/javascript" src="<?php echo e(asset('assets/users/stripe/payform.js')); ?>"></script>
