<h3 class="text-center text-warning">Contrats achetés</h3>
<table class="table">
  <thead>
    <tr>
      <th>Titre</th>
  ...
  <tbody>
    <?php $__currentLoopData = $comOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td>
          <a href="<?php echo e(route('buyer.buyerToSellerMessages', $comOrder->id)); ?>" target="_blank" class="btn btn-warning">View</a>
        </td>
      </tr>
