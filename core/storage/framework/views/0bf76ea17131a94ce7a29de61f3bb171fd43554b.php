<h3 class="text-center text-warning">Commande en cours</h3>
<table class="table">
  <thead>
    <tr>
      <th style="">Title</th>
  ...
  <tbody>
    <?php $__currentLoopData = $penOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td>
          <a href="<?php echo e(route('seller.sellerToBuyerMessages', $penOrder->id)); ?>" target="_blank" class="btn btn-warning">View</a>
        </td>
      </tr>
