    ...
    <table class="table table-bordered ">
      ...
      <tbody>
        ...
        <tr>
           ...
           <td>
              <button onclick="showWithdrawMoneyModal(<?php echo e($wm->id); ?>, document.getElementById('method<?php echo e($wm->id); ?>').innerHTML)" type="button" class="btn btn-warning">Withdraw Money</button>
           </td>
        </tr>
