          ...
          <?php endif; ?>          
           ...
           <div class="col-md-4">
              <div class="portlet box blue">
                 ...
                 <div class="portlet-body">
                    <img src="<?php echo e(asset('assets/users/interfaceControl/logoIcon/icon.jpg')); ?>" alt="icon" style="width: 100%;">
                    <br /><br />
           ...
           <div class="col-md-4">
              <div class="portlet box blue">
                 ...
                 <div class="portlet-body">
                    <img src="<?php echo e(asset("assets/users/interfaceControl/logoIcon/logo.jpg")); ?>" alt="LOGO" style="width: 100%;">
                    <br /><br />
